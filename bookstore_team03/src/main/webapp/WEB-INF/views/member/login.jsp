...
<form name="loginfrm" id="loginfrm" method="post" action="logindo" onsubmit="return loginCheck()" style="text-align: center;"><!-- myscript.js -->
      <div>
        ...
        <div href="https://kauth.kakao.com/oauth/authorize?client_id=788a4e44ddaf3b2fca76f6c08f5c2382&redirect_uri=http://localhost:9095/kakao/callback&response_type=code">
		  <svg
